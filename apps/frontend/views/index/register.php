...
<form id="login-form" action="" method="post">
    <dl class="list"><dd class="dd-padding">
        <ol class="crumbs">
    ...
    <dl class="list"><dd class="dd-padding"><input id="mobile-number" class="input-weak" type="tel" placeholder="请输入您的手机号" name="mobile" value="" autocomplete="off"></dd></dl>
    <p class="btn-wrapper">
        <label onclick="">
            <input id="term" type="checkbox" name="terms" checked="checked" class="mt"/>我已阅读并同意<a href="./terms.html">《美团网用户协议》</a>
        </label>
    </p>
    <div class="btn-wrapper">
        <button type="submit" class="btn btn-block btn-larger" disabled="disabled">获取验证码</button>
    </div>
</form>
