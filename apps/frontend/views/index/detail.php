	...
	<div id="deal" class="deal">
		<div class="list">
			...
			<dl class="list list-in">
				...
				<dd class="dd-padding agreement">
					<ul class="btn-line">
						<li><a class="btn btn-weak btn-block" data-com="share"><i
								class="text-icon icon-share"></i> 分享</a>
						
						<li><a class="js-fav-btn btn btn-weak btn-block"><i
								class="text-icon icon-star"></i> <i
								class="text-icon icon-star-empty"></i><span class="fav-text"></span></a>
						...
						<div class="merchant">
							...
							<div class="biz-call">
								<a gaevent="imt/detail/bizPhone" data-com="phonecall"
									class="react phone" href="javascript:void(0);"
									data-tele="0752-2828285/2828287"><i class="text-icon">✆</i></a>
							</div>
						</div>
					</dd>
				</dl>
		...
		<dl class="list" id="deal-feedback">
			<dd>
				<dl>
					<dt>
						评价<span class="pull-right"> <span class="stars"><i
								class="text-icon icon-star"></i><i class="text-icon icon-star"></i><i
								class="text-icon icon-star"></i><i class="text-icon icon-star"></i><i
								class="text-icon icon-star-gray"><i
									class="text-icon icon-star-half"></i></i><em class="star-text">4.7</em></span></span>
					</dt>
					...
					<dd class="dd-padding">
						<div class="feedbackCard">
							<div class="userInfo">
								<weak class="username">sally2373</weak>
							</div>
							<div class="score">
								<span class="stars"><i class="text-icon icon-star"></i><i
									class="text-icon icon-star"></i><i class="text-icon icon-star"></i><i
									class="text-icon icon-star"></i><i class="text-icon icon-star"></i></span>
						...
						<div class="feedbackCard">
							...
							<div class="comment">
								<div class="toggleContent" data-com="toggleClass">
									<p>
										今晚我们团购了两张星际穿越，超喜欢来影厅观赏科幻片，不仅看到电影的特技效果强，同时也可以给小朋友越多些和接触到新的知识。电影院的环境和座位安排得很舒适，在这影院<i
											class="text-icon icon-ell"></i><span class="feedbackmore">空间播放出来的音响效果很好，简直还有些3D效果。</span><i
			...
			<dd class="buy-comments db">
				<a class="react" href="http://i.meituan.com/deal/25965137/feedback"
					...
					<div class="more">查看全部7767条评价</div>
				</a>
			</dd>
		</dl>
