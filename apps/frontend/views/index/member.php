...
<body id="account" data-com="pagecommon">
	...
	<header class="navbar">
		...
		<div class="nav-wrap-right">
			<a class="react" href=""> <span class="nav-btn"> <i class="text-icon">⟰</i>首页
			</span>
			</a>
		</div>
		<div class="nav-wrap-right">
			<a class="react" href=""> <span class="nav-btn"> <i class="text-icon">⌕</i>搜索
			</span>
			</a>
		</div>
	</header>
	...
	<div>
		<a class="my-account" href=""> <img
			src="http://ms0.meituan.net/touch/img/my-photo.png" /> <img
			class="avater" src="http://ms0.meituan.net/touch/img/pic-default.png">
			<div class="user-info more more-weak">
				<p class="uname">
					eyeoftheworld<i class="level-icon level0"></i>
				</p>
				<p>
		...
		<dd>
			<a class="react" href="">
				<div class="more more-weak">
					<i class="text-icon order-all order-icon">⎕</i>全部团购订单<span
						data-key="all" class="more-after"></span>
				</div>
			</a>
		</dd>
		<dd>
			<ul class="orderindex">
				<li><a href="" class="react"> <i class="text-icon">⌻</i> <span>未消费</span>
						<span data-key="unused" class="amount-icon"></span>
				</a>
				
				<li><a href="" class="react"> <i class="text-icon">⌸</i> <span>待付款</span>
						<span data-key="unpaid" class="amount-icon"></span>
				</a>
				
				<li><a href="" class="react"> <i class="text-icon">⌹</i> <span>待评价</span>
						<span data-key="needfeedback" class="amount-icon"></span>
				</a>
				
				<li><a href="" class="react"> <i class="text-icon">⌺</i> <span>退款单</span>
	...
	<dl class="list">
		<dd>
			<a class="react" href=""><div class="more more-weak">
					<i class="text-icon order-zuo order-icon">座</i>电影选座订单<span
						data-key="xuanzuo" class="more-after"></span>
				</div></a>
		</dd>
		<dd>
			<a class="react" href=""><div class="more more-weak">
					<i class="text-icon order-jiudian order-icon">订</i>酒店快订订单<span
						data-key="hotel" class="more-after"></span>
				</div></a>
		</dd>
	</dl>
	...
	<dl class="list">
		<dd>
			<a class="react" href=""><div class="more more-weak">
					<i class="text-icon order-fav order-icon">☆</i>我的收藏<span
						data-key="collection" class="more-after"></span>
				</div></a>
		</dd>
		<dd>
			<a class="react" href=""><div class="more more-weak">
					<i class="text-icon order-card order-icon">□</i>我的抵用券<span
						data-key="magiccard" class="more-after"></span>
				</div></a>
		</dd>
		<dd>
			<a class="react" href=""><div class="more more-weak">
					<i class="text-icon order-lottery order-icon">⛣</i>我的抽奖单<span
						data-key="lotterys" class="more-after"></span>
				</div></a>
		</dd>
	</dl>
