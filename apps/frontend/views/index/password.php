	...
	<form method="post" action="">
		<dl class="list">
			<dd>
				<dl>
					<dd class="dd-padding">
						<input class="input-weak" placeholder="请输入当前密码" type="password"
							name="currentpassword" autocomplete="off" />
					</dd>
					<dd class="dd-padding">
						<input class="input-weak" placeholder="请输入新密码（密码长度在6-32个字符之间）"
							type="password" name="password" autocomplete="off" />
					</dd>
					<dd class="dd-padding">
						<input class="input-weak" placeholder="请输入确认新密码" type="password"
