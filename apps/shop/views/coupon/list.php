...
?>
			...
			<div class="site-crumb">
				...
				<button style="float: right;"
					onClick="postDialog('addCoupon', '<?php echo YUrl::createShopUrl('', 'Coupon', 'add'); ?>', '添加优惠券', 450, 420);"
					class="normal_btn">添加优惠券</button>
			</div>

			<div class="site-filter-bar m-t-20">
				<div class="tags">
					<ul class="cc">
						<li <?php echo ($status==-1) ? 'class="active"' : ''; ?>
							onClick="chanageStatus(-1);">全部</li>
						<li <?php echo ($status==1) ? 'class="active"' : ''; ?>
							onClick="chanageStatus(1);">未开始</li>
						<li <?php echo ($status==2) ? 'class="active"' : ''; ?>
							onClick="chanageStatus(2);">领取中</li>
						<li <?php echo ($status==3) ? 'class="active"' : ''; ?>
							onClick="chanageStatus(3);">已结束</li>
						<li <?php echo ($status==4) ? 'class="active"' : ''; ?>
							onClick="chanageStatus(4);">已过期</li>
					</ul>
				</div>
				<div class="bar">
					<dl>
				...
				<div class="list-item">
					<div class="detail cc">
						...
						<div class="col-1">
							<p class="ctrl m-t-20">
								<a href="###"
									onClick="edit(<?php echo $coupon['coupon_id'] ?>, '<?php echo $coupon['coupon_name']; ?>')">[编辑]</a>
								<a href="###"
									onclick="deleteDialog('deleteCoupon', '<?php echo YUrl::createShopUrl('', 'Coupon', 'delete', ['coupon_id' => $coupon['coupon_id']]); ?>', '<?php echo $coupon['coupon_name'] ?>')"
									title="删除">[删除]</a>
							</p>
						</div>
					</div>
