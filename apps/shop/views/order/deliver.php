...
<div class="site-form">
	<form action="<?php echo YUrl::createShopUrl('', 'Order', 'deliver'); ?>" method="post" name="myform" id="myform">
				...
				<div class="input">
					<fieldset id="custom_data">
    		            <select name="logistics_code" class="first slct">
    		            	...
    		            	<option <?php echo ($logistics_code==$code) ? 'selected="selected"' : ''; ?> value="<?php echo $code; ?>"><?php echo $name; ?></option>
    		            	<?php endforeach; ?>
    		            </select>
    			     </fieldset>
				</div>
		...
		<div class="row">
			...
			<div class="cc">
				<div class="input">
					<input type="text" style="width:200px;" class="form-input" name="logistics_number" value="<?php echo $logistics_number; ?>">
				</div>
			</div>
		</div>
