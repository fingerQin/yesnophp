...
<link type="text/css" rel="stylesheet"
	href="<?php echo YUrl::assets('css', '/account/login.css'); ?>"
	source="widget" />
...
<body>
	...
	<div class="w">
		<div id="logo">
			<a href="<?php echo YCore::config('frontend_domain_name'); ?>"><img
				src="<?php echo YUrl::assets('image', '/account/login/logo-20160623-b.png'); ?>"
				alt="不单卖" width="170" height="60"></a><b></b>
		</div>
	</div>
	<div id="content">
					...
					<div class="login-box">
						<div class="mt">
							...
							<div class="extra-r">
								<div class="regist-link">
									<a href="" target="_blank"><b></b>立即注册</a>
								</div>
							</div>
						</div>
						<div class="msg-wrap">
						...
						<div class="mc">
							<div class="form">
								<form id="formlogin" method="post">
									<input type="hidden" name="redirect_url"
										value="<?php echo $redirect_url; ?>" /> <input type="hidden"
										id="uuid" name="redirect_url" value="" />
									<div class="item item-fore1">
										<label for="loginname" class="login-label name-label"></label>
										<input id="loginname" type="text" class="itxt" name="username"
											tabindex="1" autocomplete="off" placeholder="邮箱/用户名/已验证手机" />
									...
									<div id="entry" class="item item-fore2">
										...
										<input type="password" id="nloginpwd" name="password"
											...
											placeholder="密码" /> <span class="clear-btn"></span>
									</div>
									<div class="item item-fore3">
										<div class="safe">
											<span> <input id="autoLogin" name="chkRememberMe"
												...
												for="">自动登录</label>
											</span> <span class="forget-pw-safe"> <a href="" class=""
									...
									<div class="item item-fore5">
										<div class="login-btn">
											<a href="javascript:;" class="btn-img btn-entry"
												id="loginsubmit" onClick="$('#formlogin').submit();"
												tabindex="6">登&nbsp;&nbsp;&nbsp;&nbsp;录</a>
										</div>
									</div>
								</form>
							...
							<div class="coagent">
								<h5>使用合作网站账号登录不单卖：</h5>
								<ul>
									<li><a href="javascript:void(0)" onclick="">微博</a><span
										class="line">|</span></li>
									<li><a href="javascript:void(0)" onclick="">QQ</a><span
										class="line">|</span></li>
		...
		<div id="footer-2013">
			<div class="links">
				<a rel="nofollow" target="_blank" href="">关于我们</a> | <a
					...
					target="_blank" href="">人才招聘</a> | <a rel="nofollow"
					target="_blank" href="">商家入驻</a> | <a target="_blank" href="">友情链接</a>
			</div>
			<div class="copyright">
				Copyright&copy;2004-2016&nbsp;&nbsp;不单卖budanmai.com&nbsp;版权所有</div>
		</div>
	</div>
