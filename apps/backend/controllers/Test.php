...
class TestController extends \common\controllers\Admin {
    ...
    public function userBetAction() {
        $bet_number_or_money = [
            [
                'bet_number' => '01,02,08,09,22,23:12',
                'bet_ledou'  => 10
            ],
        ];
    ...
    public function submitOrderAction() {
        ...
        $new_address_info = [
            'realname'         => '覃礼钧',
            'district_code'    => '441302007',
            'zipcode'          => '516006',
            'mobilephone'      => '18575202691',
            'receiver_address' => '仲恺大道666号科融创业大厦15楼1513',
        ];
        $data = [
            'user_id'          => 1,
    ...
    public function editGoodsAction() {
        ...
        $products = [
            '颜色:银色|尺寸:35' => ['market_price' => 129, 'sales_price' => 96, 'stock' => '996'],
            '颜色:黑色|尺寸:35' => ['market_price' => 129, 'sales_price' => 97, 'stock' => '997'],
            '颜色:银色|尺寸:38' => ['market_price' => 129, 'sales_price' => 98, 'stock' => '998'],
        ...
        $data = [
            ...
            'goods_name'   => '亚瑟士ASICS跑步鞋缓冲网面运动鞋女鞋透气跑鞋MAVERICKT25XQ-9090',
            'cat_id'       => 9,
            'slogan'       => '全店支持货到付款，折后满600再减50，满1200再减100',
            'weight'       => 500,
            'listorder'    => 0,
            'description'  => '商品详情。',
            'spec_val'     => $spec_val,
