...
class WechatController extends \common\controllers\Admin {
    ...
    public function addAccountAction() {
        if ($this->_request->isXmlHttpRequest()) {
            $data = [
                    'wx_sn' => $this->getString('wx_sn'),'wx_account' => $this->getString('wx_account'),
                    'wx_type' => $this->getInt('wx_type'),'wx_auth' => $this->getInt('wx_auth'),
                    'wx_appid' => $this->getString('wx_appid'),'wx_appsecret' => $this->getString('wx_appsecret'),
                    'wx_token' => $this->getString('wx_token'),'wx_aeskey' => $this->getString('wx_aeskey'),
                    ...
                    'wx_proxy_port' => $this->getInt('wx_proxy_port'),'admin_id' => $this->admin_id 
            ];
    ...
    public function editAccountAction() {
        if ($this->_request->isXmlHttpRequest()) {
            $data = [
                    'account_id' => $this->getInt('account_id'),'wx_sn' => $this->getString('wx_sn'),
                    'wx_account' => $this->getString('wx_account'),'wx_type' => $this->getInt('wx_type'),
                    'wx_auth' => $this->getInt('wx_auth'),'wx_appid' => $this->getString('wx_appid'),
                    'wx_appsecret' => $this->getString('wx_appsecret'),'wx_token' => $this->getString('wx_token'),
                    'wx_aeskey' => $this->getString('wx_aeskey'),'wx_cert_path' => $this->getString('wx_cert_path'),
                    'wx_cert_key' => $this->getString('wx_cert_key'),
                    'wx_report_level' => $this->getString('wx_report_level'),
                    'wx_proxy_host' => $this->getString('wx_proxy_host'),
                    'wx_proxy_port' => $this->getInt('wx_proxy_port'),'admin_id' => $this->admin_id 
