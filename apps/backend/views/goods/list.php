...
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		...
		<div class="explain-col">
     		...
     		商品价格：<input type="text" value="<?php echo $start_price; ?>" class="input-text" name="start_price" style="width:50px;"  placeholder="" /> ~ <input type="text" value="<?php echo $end_price; ?>" class="input-text" style="width:50px;" name="end_price" placeholder="" />
...
<table width="100%" cellspacing="0">
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
    		<td align="center"><img width="120" src="<?php echo $item['goods_img']; ?>" /></td>
