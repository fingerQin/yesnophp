			...
			<div class="table-list">
				<table width="100%" cellspacing="0">
					...
					<?php foreach ($list as $cat): ?>
						<tr>
							<td align='center'><input name='listorders[<?php echo $cat['cat_id']; ?>]' type='text' size='3' value='<?php echo $cat['listorder']; ?>' class='input-text-c'></td>
						...
						<tr>
							<td align='center'><input name='listorders[<?php echo $sub_m['cat_id']; ?>]' type='text' size='3' value='<?php echo $sub_m['listorder']; ?>' class='input-text-c'></td>
						...
						<tr>
							<td align='center'><input name='listorders[<?php echo $ss_m['cat_id']; ?>]' type='text' size='3' value='<?php echo $ss_m['listorder']; ?>' class='input-text-c'></td>
