...
<div class="subnav">
	<div class="content-menu ib-a blue line-x">
		<a class="add fb"
			href="javascript:postDialog('addShop', '<?php echo YUrl::createBackendUrl('', 'Shop', 'add'); ?>', '添加商家', 600, 580)"><em>添加商家</em></a>
					...
					<td>
						<div class="explain-col">
							<p style="margin-top: 10px;">
								<input type="text" value="<?php echo $shop_name; ?>"
									class="input-text" name="shop_name" placeholder="商家名称" /> <input
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
						<td align="center"><img width="120"
							src="<?php echo $item['shop_logo']; ?>" /></td>
						...
						<td align="center"><a href="###"
							onclick="edit(<?php echo $item['shop_id'] ?>, '<?php echo $item['shop_name'] ?>')"
							title="修改">修改</a> | <a href="###"
							onclick="deleteDialog('deleteShop', '<?php echo YUrl::createBackendUrl('', 'Shop', 'delete', ['shop_id' => $item['shop_id']]); ?>', '<?php echo $item['shop_name'] ?>')"
							title="删除">删除</a></td>
					</tr>
    <?php endforeach; ?>
    </tbody>
...
function edit(id, name) {
	...
	postDialog('editShop', page_url, title, 600, 580);
}
</script>
</body>
</html>