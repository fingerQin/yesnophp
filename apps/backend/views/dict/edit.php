...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
    <tr>
		...
		<td><input type="text" name="dict_code" id="dict_code" size="40" class="input-text" value="<?php echo htmlspecialchars($dict['dict_code']); ?>"></td>
	</tr>
    <tr>
		<th width="100">字典值：</th>
	...
	<tr>
		...
		<td><textarea name="description" id="dict_description" style="width:300px;" rows="5" cols="50"><?php echo htmlspecialchars($dict['description']); ?></textarea></td>
	</tr>
	<tr>
