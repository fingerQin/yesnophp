...
<div class="pad_10">
<form action="<?php echo YUrl::createAdminUrl('Index', 'Cash', 'createAccountCheck'); ?>" method="post" name="dialog_form" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">

	<tr>
		<th width="100">对账单标题：</th>
		<td><input type="text" name="title" id="cash_title" size="40" class="input-text" value=""></td>
	</tr>
	<tr>
		<th>厂商</th>
		<td>
