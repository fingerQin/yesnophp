...
<table width="100%" cellspacing="0" class="search-form">
    <tbody>
		...
		<div class="explain-col">
     		...
     		上传时间：<input type="text" name="starttime" id="starttime" value="<?php echo $starttime; ?>" size="20" class="date input-text" /> ～ <input type="text" name="endtime" id="endtime" value="<?php echo $endtime; ?>" size="20" class="date input-text" />
...
<table width="100%" cellspacing="0">
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
    		...
    		<td align="center"><a target="_blank" href="<?php echo YUrl::filePath($item['image_url']); ?>"><img width="120" height="120" src="<?php echo YUrl::filePath($item['image_url']); ?>" /></a></td>
