...
<div class="pad_10">
<form action="<?php echo YUrl::createBackendUrl('', 'News', 'edit'); ?>" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
    <tr>
		...
		<?php foreach ($news_cat_list as $cat): ?>
    		<option <?php echo $cat['cat_id']==$detail['cat_id'] ? 'selected="selected"' : ''; ?> value="<?php echo $cat['cat_id']; ?>"><?php echo $cat['cat_name']; ?></option>
        <?php endforeach; ?>
		</select>
		</td>
	</tr>
	...
	<tr>
		...
		<td><?php echo $frontend_url; ?>article/<input type="text" name="code" id="code" size="10" class="input-text" value="<?php echo $detail['code']; ?>">(自定义URL)</td>
	</tr>
	<tr>
		<th width="100">关键词：</th>
		<td><input type="text" name="keywords" id="keywords" size="40" class="input-text" value="<?php echo htmlspecialchars($detail['keywords']) ?>"></td>
	</tr>
	<tr>
		<th width="100">文章简介：</th>
		<td><textarea name="intro" id="intro" style="width:600px;" rows="5" cols="50"><?php echo htmlspecialchars($detail['intro']) ?></textarea></td>
	</tr>
	<tr>
		<th width="100">来源：</th>
		<td><input type="text" name="source" id="source" size="20" class="input-text" value="<?php echo htmlspecialchars($detail['source']) ?>"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
            ...
            <div id="previewImage"><img width="120" height="120" src="<?php echo YUrl::filePath($detail['image_url']); ?>" /></div>
		</td>
	</tr>
	<tr>
		<th width="100">文章内容：</th>
		<td><textarea name="content" id="editor_id" style="width:600px;" rows="5" cols="50"><?php echo $detail['content']; ?></textarea></td>
	</tr>
    <tr>
