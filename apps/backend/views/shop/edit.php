...
<div class="common-form">
	<form name="myform" id="myform"
		action="<?php echo YUrl::createBackendUrl('', 'Shop', 'edit'); ?>"
		method="post">
		<table width="100%" class="table_form contentWrap">
			<tr>
				<th>商家名称：</th>
				<td><input type="hidden" name="shop_id" id="shop_id"
					value="<?php echo $detail['shop_id']; ?>"> <input type="text"
					name="shop_name" id="shop_name"
					value="<?php echo $detail['shop_name']; ?>" style="width: 300px;"
					class="input-text"></td>
			</tr>
			<tr>
				<th>商家拥有人账号：</th>
				<td><input type="text" name="account" id="account"
					...
					value="<?php echo $detail['account']; ?>">(可以为空)</td>
			</tr>
			<tr>
				<th>联系人：</th>
				<td><input type="text" name="link_man" id="link_man"
					value="<?php echo $detail['link_man']; ?>" style="width: 120px;"
					class="input-text"></td>
			</tr>
			<tr>
				<th>联系手机：</th>
				<td><input type="text" name="mobilephone" id="mobilephone"
					style="width: 120px;" class="input-text"
					value="<?php echo $detail['mobilephone']; ?>" /> <span
					style="margin-left: 20px;">联系座机：</span> <input type="text"
					name="telephone" id="telephone" style="width: 120px;"
					class="input-text" value="<?php echo $detail['telephone']; ?>" /></td>
			</tr>
			<tr>
				<th>联系QQ：</th>
				<td><input type="text" name="qq" id="qq"
					value="<?php echo $detail['qq']; ?>" style="width: 120px;"
					class="input-text" /></td>
			</tr>
			<tr>
				<th>最大商品数：</th>
				<td><input type="text" name="max_goods_count" id="max_goods_count"
					value="<?php echo $detail['max_goods_count']; ?>"
					style="width: 50px;" class="input-text" /></td>
			</tr>
			<tr>
				<th>是否允许删评：</th>
				<td><select name="is_allow_delete_comment">
						<option
							<?php echo $detail['is_allow_delete_comment'] ? 'selected="selected"' : ''; ?>
							value="1">是</option>
						<option
							<?php echo !$detail['is_allow_delete_comment'] ? 'selected="selected"' : ''; ?>
							value="0">否</option>
					...
					name="is_lock">
						<option
							<?php echo $detail['is_lock'] ? 'selected="selected"' : ''; ?>
							value="1">是</option>
						<option
							<?php echo $detail['is_lock'] ? 'selected="selected"' : ''; ?>
							value="0">否</option>
			...
			<tr>
				...
				<td><input type="hidden" name="shop_logo" id="shop_logo"
