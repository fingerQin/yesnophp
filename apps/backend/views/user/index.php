...
<div class="subnav">
    <div class="content-menu ib-a blue line-x">
    	<a class="add fb" href="javascript:postDialog('addUser', '<?php echo YUrl::createAdminUrl('Index', 'User', 'add'); ?>', '添加用户', 500, 400)"><em>添加用户</em></a>
...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			...
			<th width="15%" align="left">手机号码</th>
			<th width="20%" align="left">手机验证</th>
    ...
    <?php foreach ($list as $item): ?>
    	<tr>
    		...
    		<td align="left"><?php echo $item['is_verify_mobilephone'] ? '是' : '否'; ?></td>
    		<td align="left"><?php echo $item['email']; ?></td>
    		<td align="center"><?php echo $item['is_verify_email'] ? '是' : '否'; ?></td>
...
function edit(id, name) {
	var title = '修改『' + name + '』';
	var page_url = "<?php echo YUrl::createAdminUrl('Index', 'User', 'edit'); ?>?user_id="+id;
