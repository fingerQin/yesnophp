...
<div class="pad_10">
	<form
		action="<?php echo YUrl::createBackendUrl('', 'User', 'edit'); ?>"
		method="post" name="myform" id="myform">
		<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
			<tr>
				<th width="100">用户类型：</th>
				<td><select name="user_type" id="user_type" disabled="disabled">
						<option
							<?php echo ($userinfo['user_type']=='normal') ? 'selected="selected"' : ''; ?>
							value="normal">普通用户</option>
						<option
							<?php echo ($userinfo['user_type']=='shop') ? 'selected="selected"' : ''; ?>
							value="shop">商家用户</option>
				</select></td>
			</tr>
			<tr>
				<th width="100">账号：</th>
