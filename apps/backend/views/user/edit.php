...
<div class="pad_10">
<form action="<?php echo YUrl::createAdminUrl('Index', 'User', 'edit'); ?>" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	<tr>
		<th width="100">账号：</th>
		<td><input type="text" name="username" id="username" size="40" class="input-text" value="<?php echo $userinfo['username']; ?>"></td>
	</tr>
	<tr>
		<th width="100">密码：</th>
	...
	<tr>
		...
		<td><input type="text" name="mobilephone" id="mobilephone" size="40" class="input-text" value="<?php echo $userinfo['mobilephone']; ?>"></td>
	</tr>
	<tr>
		<th width="100">邮箱：</th>
		<td><input type="text" name="email" id="email" size="20" class="input-text" value="<?php echo $userinfo['email']; ?>"></td>
	</tr>
	<tr>
		<th width="100">真实姓名：</th>
		<td><input type="text" name="realname" id="realname" size="20" class="input-text" value="<?php echo $userinfo['realname']; ?>"></td>
	</tr>
	<tr>
		<th width="100">签名：</th>
		<td><input type="text" name="signature" id="signature" size="20" class="input-text" value="<?php echo $userinfo['signature']; ?>"></td>
	</tr>
	<tr>
		<th width="100">头像：</th>
		<td>
		    <input type="hidden" name="avatar" id="input_voucher" value="<?php echo $userinfo['avatar']; ?>" />
            <div id="previewImage">
            <?php if (strlen($userinfo['avatar']) > 0): ?>
            <img width="120" height="120" src="<?php YUrl::filePath($userinfo['avatar']); ?>" />
            <?php endif; ?>
            </div>
		</td>
	</tr>
