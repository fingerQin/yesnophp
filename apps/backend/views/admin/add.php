...
<div class="pad_10">
<form action="<?php echo YUrl::createAdminUrl('Index', 'Admin', 'add'); ?>" method="post" name="myform" id="myform" autocomplete="off">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">

	<tr>
		<th width="80">账号：</th>
		<td><input type="text" name="username" id="username" size="20" class="input-text" value="">（字母、数字、下划线组成）</td>
	</tr>
	<tr>
		<th width="80">密码：</th>
		<td><input type="password" name="password" id="password" size="20" class="input-text" value="">（字母、数字、下划线组成）</td>
	</tr>
	<tr>
		<th width="80">真实姓名：</th>
