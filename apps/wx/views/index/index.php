    ...
    <div class="weui_tabbar">
        <a href="javascript:;" class="weui_tabbar_item weui_bar_item_on">
            <div class="weui_tabbar_icon">
                <img src="<?php echo YUrl::assets('image', '/wx/icon_nav_button.png'); ?>" alt="">
            </div>
            <p class="weui_tabbar_label">微信</p>
        </a>
        <a href="javascript:;" class="weui_tabbar_item">
            <div class="weui_tabbar_icon">
                <img src="<?php echo YUrl::assets('image', '/wx/icon_nav_msg.png'); ?>" alt="">
            </div>
            <p class="weui_tabbar_label">通讯录</p>
        </a>
        <a href="javascript:;" class="weui_tabbar_item">
            <div class="weui_tabbar_icon">
                <img src="<?php echo YUrl::assets('image', '/wx/icon_nav_article.png'); ?>" alt="">
            </div>
            <p class="weui_tabbar_label">发现</p>
        </a>
        <a href="javascript:;" class="weui_tabbar_item">
            <div class="weui_tabbar_icon">
                <img src="<?php echo YUrl::assets('image', '/wx/icon_nav_cell.png'); ?>" alt="">
            </div>
