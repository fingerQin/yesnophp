...
<body>
	...
	<article class="docBody clearfix newBetPage">
		<header id="header">
			<h1>双色球</h1>
			<a href="javascript:;" cpurl="" class="rightBox" rel="nofollow">往期开奖</a> <a class="goBack " href="javascript:;" cpurl="/t/index.html" target="_self" rel="nofollow">返回</a>
		</header>
		<section id="wraper" style="height: 760px;">
			<div>
				...
				<div class="gameTip clearfix">
					<span class="l_box rockTip" style="">摇一摇机选</span> <span
						class="r_box">至少选择6个红球，1个蓝球</span>
				</div>
				<div class="betBox">
