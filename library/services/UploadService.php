...
class UploadService extends BaseService {
    ...
    public static function saveImage($file_content, $user_type = 2, $user_id = 0, $dirname = '') {
        ...
        $fileinfo = [];
        $fileinfo[] = [
                'file_id' => $file_id,'image_url' => $statics_domain_name . $file_name,
    ...
    public static function uploadOtherFile($user_type = 2, $user_id = 0, $dirname = '', $file_size = 0) {
        ...
        $allow_exts = [
                'zip','rar','doc','docx','xls','xlsx','pptx','ppt','gz','bz2','mp3','ogg','mp4','avi','flv','mpeg','wmv',
                'mkv','3gp','mpg','mpeg','rm','rmvb','vob','mov','amr','wav','txt','pdf','dmg' 
        ];
