...
class LinkService extends BaseService {
    ...
    public static function getLinkDetail($link_id) {
        $link_model = new Link();
        $data = $link_model->fetchOne([], [
                'link_id' => $link_id,'status' => 1 
        ]);
        if (empty($data)) {
    ...
    public static function addLink($admin_id, $link_name, $link_url, $cat_id, $image_url, $display = 1) {
        $link_model = new Link();
        $data = [
                'link_name' => $link_name,'link_url' => $link_url,'cat_id' => $cat_id,'image_url' => $image_url,
                'display' => $display 
        ];
        $rules = [
                'link_name' => '友情链接名称|require:1000000|len:1000000:1:20:1',
                'link_url' => '友情链接URL|require:1000000|len:1000000:1:100:1|url:1000000',
                'cat_id' => '友情链接分类|require:1000000|integer:1000000','image_url' => '友情链接图片|len:1000000:1:100:1',
