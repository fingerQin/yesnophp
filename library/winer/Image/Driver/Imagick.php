...
class Imagick {
    ...
    public function open($imgname) {
        ...
        // 设置图像信息
        $this->info = array(
                'width' => $this->img->getImageWidth(),'height' => $this->img->getImageHeight(),
                'type' => strtolower($this->img->getImageFormat()),'mime' => $this->img->getImageMimeType() 
        );
    }
    ...
    public function water($source, $locate = Image::IMAGE_WATER_SOUTHEAST, $alpha = 80) {
        ...
        $info = array(
                $water->getImageWidth(),$water->getImageHeight() 
        );
