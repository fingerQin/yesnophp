...
class Dict extends DbBase {
    ...
    public function isNotEmpty($dict_type_id) {
        $where = [
                'dict_type_id' => $dict_type_id,'status' => 1 
        ];
    ...
    public function addDict($admin_id, $dict_type_id, $dict_code, $dict_value, $description = '', $listorder = 0) {
        $data = [
                ...
                'description' => $description,'listorder' => $listorder,'status' => 1,'created_by' => $admin_id,
    ...
    public function editDict($dict_id, $admin_id, $dict_code, $dict_value, $description = '', $listorder = 0) {
        $data = [
                'dict_code' => $dict_code,'dict_value' => $dict_value,'description' => $description,
                'listorder' => $listorder,'status' => 1,'modified_by' => $admin_id,
    ...
    public function sort($admin_id, $dict_id, $sort) {
        $data = [
                'modified_by' => $admin_id,'listorder' => $sort,'modified_time' => $_SERVER['REQUEST_TIME'] 
        ];
        $where = [
                'dict_id' => $dict_id 
        ];
