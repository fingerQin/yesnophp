...
class DictType extends DbBase {
    ...
    public function addDictType($admin_id, $type_code, $type_name, $description) {
        ...
        $data = [
                'type_code' => $type_code,'type_name' => $type_name,'description' => $description,
                'created_by' => $admin_id,'status' => 1,'created_time' => $_SERVER['REQUEST_TIME'] 
        ];
        $id = $this->insert($data);
    ...
    public function editDictType($admin_id, $dict_type_id, $type_code, $type_name, $description) {
        $data = [
                'type_code' => $type_code,'type_name' => $type_name,'description' => $description,
                'modified_by' => $admin_id,'modified_time' => $_SERVER['REQUEST_TIME'] 
        ];
        $where = [
                'dict_type_id' => $dict_type_id 
        ];
